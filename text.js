javascript:(function(){
const nearbyMapURL="ｈｔｔｐ://alizzzxoxo.github.io/bookmarklet-/nearbyMap.js";
...
// ===== CSS =====
const style = `#tc_tutor_filter_ui {   position:fixed;top:54px;left:auto;right:24px;z-index:99999;   background:#fff;border:2px solid #99c9ff;border-radius:14px;   box-shadow:2px 2px 16px #0002;   min-width:320px;max-width:96vw;width:380px;height:auto;   padding:13px 15px 10px 15px;   font-family:system-ui,sans-serif;font-size:15px;   cursor:grab;user-select:none;   transition:box-shadow .2s; } #tc_tutor_filter_ui.dragging { box-shadow:0 0 0 4px #2196f366; } #tc_tutor_filter_ui .tc-row {margin-bottom:10px;} #tc_tutor_filter_ui .tc-tags {display:flex;flex-wrap:wrap;gap:6px;} #tc_tutor_filter_ui .tc-tag {   border-radius:6px;padding:5px 13px;font-size:15px;font-weight:500;   border:1.4px solid #c4e0ff;background:#f9fcff;color:#1976d2;   cursor:pointer;transition:all .13s; } #tc_tutor_filter_ui .tc-tag.tc-on {   background:#d1ebff;color:#1976d2;border-color:#2196f3;font-weight:bold; } #tc_tutor_filter_ui .tc-tag.tc-off {   background:#f5f6fa;color:#aaa;border-color:#e5e9f2; } #tc_tutor_filter_ui .tc-btn {   margin-top:7px;padding:7px 13px;border-radius:7px;   border:1.2px solid #69b6ff;background:#f2faff;   color:#2196f3;font-size:15px;cursor:pointer;font-weight:bold; } #tc_tutor_filter_ui .tc-btn.tc-close {   float:right;margin:0 0 0 7px;background:none;border:none;   color:#ec5050;font-size:17px;font-weight:normal;cursor:pointer; } #tc_tutor_filter_ui .tc-label {   font-size:18px;   color:#407fa6;   margin-bottom:3px;   font-weight:bold; } #tc_tutor_filter_ui textarea {   width:100%;min-height:220px;max-height:420px;height:220px;overflow:auto;   font-size:15px;margin-top:3px;margin-bottom:2px;   border-radius:5px;border:1.2px solid #b8e0ff;   padding:6px 8px;background:#fafdff;   resize:vertical;box-sizing:border-box;line-height:1.5;   display:block; } #tc_tutor_filter_ui .tc-taginput {   border:1.1px solid #b8e0ff;border-radius:5px;padding:3px 7px;font-size:15px;margin-top:6px;margin-bottom:2px;width:96%;   display:block;   background:#fffbe6; } #tc_tutor_filter_ui .tc-none {margin-top:9px;color:#999;font-size:14px;} .tc-tutor-reason-box {   display:flex !important; align-items:center; justify-content:center;   min-height:0; min-width:0; width:100%;   background:transparent !important; border:none !important; box-shadow:none !important;   padding:0 !important; margin:12px auto 12px auto !important;   transition:max-height .25s cubic-bezier(.85,0,.15,1), opacity .22s;   opacity:1; max-height:200px; overflow:visible; } .tc-tutor-reason {   background:#fff2f2;   color:#c33;font-size:17px;line-height:1.7;   border-radius:12px;padding:18px 20px 16px 20px;   margin:0 auto;display:block;max-width:95vw;min-width:0;width:100%;   border:2px solid #ffbebe;   font-weight:bold;   cursor:pointer;   box-shadow:0 2px 14px #ffcaca4d;   transition:box-shadow .2s,background .2s,transform .25s;   text-align:center;   word-break:break-word;white-space:pre-line;   letter-spacing:0.5px;   min-height:36px;   z-index:2;   opacity:1;   user-select: text; } .tc-tutor-reason:hover {background:#ffe5e5;box-shadow:0 2px 24px #ff8d8d44; } .tc-tutor-card-collapsed {   display:block !important; max-height:0 !important; overflow:hidden !important; opacity:0 !important; padding:0 !important; margin:0 !important; border:none !important; box-shadow:none !important;   pointer-events:none !important;   transition:max-height .25s cubic-bezier(.85,0,.15,1), opacity .22s; } .tc-tutor-card-expanded {   display:block !important; opacity:1 !important; max-height:4000px !important; transition:max-height .25s cubic-bezier(.85,0,.15,1), opacity .22s; } .tc-highlight {   background: #ffe066 !important;   color: #c65000 !important;   font-weight: bold;   border-radius: 4px;   padding: 1px 3px;   box-shadow: 0 0 0 1px #ffdf80;   /* animation: highlightfade 2s; */ };`;
...
bar.style.cssText =       "position:absolute;left:0;right:0;top:-28px;margin:auto;width:90%;min-width:0;max-width:290px;padding:7px 0 6px 0;background:rgba(60,60,120,0.93);color:#fff;text-align:center;font-size:14px;border-radius:10px 10px 0 0;z-index:2;transition:opacity .2s;pointer-events:none;";
box.prepend(bar);
}
bar.textContent = msg;
bar.style.opacity = 1;
...
// ====== 進階判斷：只有明確成績才啟用 ======
let gradeReq = (c.grade && c.grade.length > 0);
if(!gradeReq && c.special) {
if(/[345][*＊星]{0,2}/.test(c.special)) gradeReq = true;
}
filterState.grade = gradeReq;
// ========================================
